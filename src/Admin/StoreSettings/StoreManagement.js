		...
		allLoyaltyPointsAndStoreStatus(token).then((data) => {
			if (data.error) {
				...
				if (lastStoreSettings) {
					...
					setActivatePayOnDelivery(lastStoreSettings.activatePayOnDelivery);
					setActivatePickupInStore(lastStoreSettings.activatePickupInStore);
					setActivatePayOnline(lastStoreSettings.activatePayOnline);
					setSameDayShippingStart(lastStoreSettings.sameDayShippingStart);
					setSameDayShippingEnd(lastStoreSettings.sameDayShippingEnd);
							...
							>
								<label className='text-muted'>
									{chosenLanguage === "Arabic"
										...
										: "Total KD Value Limit To get Free Shipping"}
								</label>
								<input
									type='number'
									className='form-control'
									...
									placeholder='Min KD value purchase to get free shipping (e.g. 100 KD will be added as 100)'
								/>
							</div>
						</div>
					...
					<div className='row my-2'>
						...
						<div className='col-md-3 mx-auto'>
							...
							>
								...
								<span style={{ color: "green", fontWeight: "bolder" }}>
									{activatePickupInStore ? "(Activated)" : ""}
								</span>{" "}
