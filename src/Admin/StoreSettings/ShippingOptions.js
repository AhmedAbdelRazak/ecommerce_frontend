...
const ShippingOptions = () => {
	...
	const newShippingOptionForm = () => (
		<form onSubmit={clickSubmit}>
			...
			<div className='row'>
				<div
					className='form-group col-md-5 mx-auto'
					style={{ textAlign: chosenLanguage === "Arabic" ? "right" : "left" }}
				>
					<label className='text-muted'>
						{" "}
						{chosenLanguage === "Arabic"
							? "اسم عرض الشحن باللغة الإنجليزية"
							: "Carrier/Package Name In English"}{" "}
					</label>
					<input
						type='text'
				...
				>
					<label className='text-muted'>
						{chosenLanguage === "Arabic"
							? "اسم عرض الشحن باللغة العربية"
							: "Carrier/Package Name In Arabic"}
					</label>
					<input
						type='text'
						className='form-control'
				...
				>
					<label className='text-muted'>
						{chosenLanguage === "Arabic" ? "سعر الشحن" : "Shipping Price"}
					</label>
					<input
						type='number'
						className='form-control'
				...
				<div
					...
					style={{ textAlign: chosenLanguage === "Arabic" ? "right" : "left" }}
				>
					<label>{chosenLanguage === "Arabic" ? "العملة" : "Currency"}</label>
					<select
			...
			>
				...
				>
					{" "}
					{chosenLanguage === "Arabic"
						? "الشحن غير متاح في أيام:"
						: "Shipping Unavailable on days:"}{" "}
				</label>
